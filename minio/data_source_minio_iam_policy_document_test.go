...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017 = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions   = ["s3:*"]
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ExpectedJSON = `{
  "Version": "2008-10-17",
  "Statement": [
    {
      "Sid": "",
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ConversionCondition = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions   = ["*"]
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ConversionNotPrincipals = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions   = ["*"]
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ConversionNotResources = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions       = ["*"]
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ConversionPrincipal = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions   = ["*"]
...
const testAccMinioIAMPolicyDocumentDataSourceConfigVersion20081017ConversionResources = `
data "minio_iam_policy_document" "test" {
  version = "2008-10-17"
   statement {
    actions   = ["*"]
